...
*/	  
    ...
    window.window['ZoomImage'] = function() {
      ...
      function updateMagnifier( x, y ) {
        ...
        Iy = EID('header').offsetHeight - img.offsetHeight; //(H - img.offsetHeight)/2 + EID('header').offsetHeight; //EID('header').offsetHeight - ECN('content', 'zoom-container')[0].offsetHeight;
        Zw = zoom.offsetWidth;
        Zh = zoom.offsetHeight;
